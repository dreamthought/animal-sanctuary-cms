import{s as l,n as o}from"../chunks/scheduler.S4wXxuDW.js";import{S as d,i as m,s as h,e as p,h as f,d as r,c as u,a as w,g,b as v,f as n}from"../chunks/index.g_WIspXK.js";function b(c){let s,e,i=`<h1>SHOP HERE TO HELP THE ANIMALS</h1> <div class="container"><p class="text-center"><b>Whenever you shop with one of the links below, you automatically help The Animal Sanctuary.
    ...
    }<\/script></div>`;return{c(){s=h(),e=p("div"),e.innerHTML=i,this.h()},l(t){f("svelte-13kr8ce",document.head).forEach(r),s=u(t),e=w(t,"DIV",{class:!0,"data-svelte-h":!0}),g(e)!=="svelte-wz0zsj"&&(e.innerHTML=i),this.h()},h(){document.title="Shop - Online Op Shop and PEtsy Store | The Animal Sanctuary",v(e,"class","container custom-content shadow-lg")},m(t,a){n(t,s,a),n(t,e,a)},p:o,i:o,o,d(t){t&&(r(s),r(e))}}}class S extends d{constructor(s){super(),m(this,s,null,b,l,{})}}export{S as component};
