...
<div class="container custom-content shadow-lg">
  ...
  <div class="container">
    <p>
      <b>Because there are a number of rescue agencies set up for dogs and cats, The Sanctuary’s primary focus is on other creatures in need of help… 
      and in particular animals that have been ill-treated.</b>
    </p>
    <p>
      The Sanctuary has so far provided a safe haven for a variety of donkeys, pigs, goats, battery hens, parrots, ducks, dogs, cats, a turtle and a turkey!
    </p>
    <p>
      All of these animals were suffering from neglect or direct abuse, and desperately needed a good home with lots of tender loving care. 
      ...
      Click on the links below to meet some of our happy residents!
    </p>
  </div>
    <div class="row">
      <div class="col-md-3">
