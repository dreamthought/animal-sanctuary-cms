...
<div class="container custom-content shadow-lg">
  ...
  <div class="row">
    ...
    <div class="col-lg-6">
      <p>
      <b>The Sanctuary is animal refuge with charitable trust status, run by Shawn Bishop and Michael Dixon in Matakana, New Zealand. 
      We provide a safe haven for abused and neglected animals, and care for injured or orphaned native birds.</b>
      </p>
      <p>
  ...
  <!-- What We Do -->
  <div class="row">
    <h2 class="mb-3">The Animal Sanctuary is a haven for all animals, with a focus on three main areas of work:</h2>
    <div class="col-md-4">
