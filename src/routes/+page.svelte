  ...
  <div class="row">
    <div class="col-xl-6 mb-3">
      ...
      <div class="container-iframe">
        <iframe class="responsive-iframe rounded"
                src="https://player.vimeo.com/video/921637852?h=3570e547eb&title=0&byline=0&portrait=0" 
                allow="fullscreen"
                title="The Animal Sanctuary Vimeo promo video">
        </iframe>
      </div>
      <!-- End Video -->
    </div>
    ...
    <div class="col-xl-6">
      ...
      <p class="text-center">
        <b>You can <a href="https://www.youtube.com/watch?v=13F_Em_z83E" target="_blank" class="in-text-link">watch our video</a>
        to learn more about what we do, 
        and <a href="https://www.facebook.com/TheAnimalSanctuaryNZ" target="_blank" class="in-text-link-facebook">Follow us on Facebook</a> to see what we get up to.</b>
      </p>
    </div>
  </div>
  <!-- End Intro -->
