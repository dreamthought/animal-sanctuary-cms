<svelte:head>
  ...
  <meta name="description" content="SEO Stuff - Lucia to add"/>
  <meta name="keywords" content="animals,sanctuary,charity,chicken,duck,donkey,horse"/>
  ...
  <script lang="javascript" src="https://cdn.jsdelivr.net/npm/bootstrap@5.3.2/dist/js/bootstrap.min.js"
    ...
    <div class="container custom-content shadow-lg">
      ...
      <div class="row">
        ...
        <div class="col-md-6">
          ...
          <p class="fs-5">
          You can <a href="https://player.vimeo.com/video/447269165?color&amp;autopause=0&amp;loop=1&amp;muted=0&amp;title=0&amp;portrait=0&amp;byline=0#t=" target="_blank" class="in-text-link">watch our video</a>
      ...
      <!-- What We Do -->
      <h2>The Animal Sanctuary is a haven for all animals, with a focus on three main areas of work:</h2>
      <div class="row">
        <div class="col-md-4">
